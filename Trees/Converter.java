/**
 * Converter class which converts String to Long
 * @author Kaushik 
 *
 */
...
public class Converter {
	/**
	 * Does String to Long Conversion.Equivalent of Long.parseLong of Java
	 * 
	 * @param s The input String
	 * @return long The equivalent long value
	...
	public static void test()
	{
		...
		long normalneg =StringToLong("-123");
		check(normalneg,-123L);
		...
		try{
			long exceedrangeneg =StringToLong("-9223372036854775809");//Exceeds negative limit
		...
		try{
			long exceedrangepos =StringToLong("9223372036854775808");//Exceeds positive limit
